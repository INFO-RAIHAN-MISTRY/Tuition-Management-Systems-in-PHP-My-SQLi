			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="navbarColor03">
			      <ul class="navbar-nav me-auto">
			        ...
			        <li class="nav-item">
			          <a class="nav-link" href="./courses.php"><i class="fa-solid fa-book p-2"></i>Courses</a>
			        </li>
			        <!-- <li class="nav-item">
			        ...
			        <li class="nav-item dropdown">
			          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-users p-2"></i>Students</a>
			        ...
			        <li class="nav-item dropdown">
			          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-indian-rupee-sign p-2"></i></i>Fees</a>
			          <div class="dropdown-menu">
			            <a class="dropdown-item" href="./fees.php">Collect Fees</a>
			            <a class="dropdown-item" href="./transactions.php">Transactions</a>
			          </div>
			        </li>
			        <li class="nav-item">
			          <a class="nav-link" href="./reports.php"><i class="fa-solid fa-file p-2"></i>Reports</a>
			        </li>
			        <li class="nav-item dropdown">
